...
O inventário parte do código e dos documentos existentes em 05/09/2026. Hoje o protótipo usa JSON no servidor, guarda respostas e eventos sem criptografia de campo, mantém tokens de sessão em texto no servidor e no `localStorage`, e persiste localmente respostas do teste de temperamento. O modelo alvo prevê PostgreSQL, hashes de tokens, isolamento por casal e respostas bilaterais. O inventário distingue esse estado atual do tratamento planejado; ele não declara conformidade da implementação.
...
| OP-17 | Pesquisa e teste de usabilidade; DG-17; participantes | Aprender com uso e melhorar o produto | Art. 7º, I, consentimento; consentimento separado para áudio ou vídeo e para citação identificável | Equipe de pesquisa; transcrição por operador contratado se houver | RT-11; anonimizar a síntese e permitir retirada até a anonimização | Roteiro existente; recrutamento e consentimento pendentes |
