...
134;MPV de teste;Qualidade;Executar QA do caminho feliz e falhas básicas;MPV candidato à validação;Crítica;132,133,138,139;Qualidade;Em andamento;5;16/09/2026;21/09/2026;API serviço integrado e matriz móvel revalidados com sucesso em 16/09/2026 após a passagem física no Chrome — pendem concluir as verificações formais de acessibilidade da tarefa 133 e registrar o aceite final — Safari permanece fora da cobertura atual
135;MPV de teste;Operação;Disponibilizar demonstração controlada;Link de demonstração;Crítica;134;Engenharia Frontend;Concluído;4;16/09/2026;16/09/2026;Demonstração HTTPS publicada no Render gratuito com Web Service PostgreSQL de 1 GB sonda de saúde CORS restrito bloqueio de indexação e segredo operacional — envio persistência exportação e passagem física no Chrome validados base técnica limpa e banco expira em 16/10/2026 sem backup — Safari permanece fora da cobertura atual
...
$milestones = @(
  ...
  @('MPV2','Dois jogos jogáveis','131','Concluído','Jornadas completas com lote mínimo e feedback no produto','19/09/2026'),
  @('MPV3','Demonstração do teste pronta','135','Em andamento','Link controlado disponível e QA em curso com aceite físico restrito ao Chrome','22/09/2026'),
