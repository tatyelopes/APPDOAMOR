...
41;Infraestrutura;DevOps;Provisionar banco PostgreSQL;Banco por ambiente;Crítica;34,38;;Não iniciado;10;;;Provisionar PostgreSQL e migrações executáveis a partir do modelo 34 - validar integridade e concorrência - JSON atual retorna banco vazio ao falhar leitura e não oferece transações
...
118;Infraestrutura;Recuperação;Ensaiar restauração de backup e retorno de migração;Evidência de recuperação;Crítica;41,38;DevOps/Plataforma;Não iniciado;8;;;Executar em ambiente isolado conferir integridade e documentar procedimento antes do piloto - estimativa preliminar
