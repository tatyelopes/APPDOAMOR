...
126;MPV de teste;UX;Simplificar a jornada para entrada escolha jogo rodada e feedback;Fluxo do MPV;Crítica;125;Product Designer;Concluído;4;13/09/2026;14/09/2026;Fluxo aprovado em docs/FLUXO-MPV.md com seis estados entrada direta dois jogos de três rodadas três sinais e sugestão opcional exceções e critérios de aceite — atualizado em 16/09/2026
...
131;MPV de teste;Feedback;Adicionar fechamento e feedback de três sinais;Feedback funcional;Alta;129,130;Engenharia Frontend;Concluído;4;19/09/2026;19/09/2026;Feedback binário compartilhado implementado nos dois jogos e integrado ao registro central do jogo concluído clareza descoberta ou conexão e intenção de jogar novamente sem conteúdo das rodadas — concluído antecipadamente em 12/09/2026 e integrado em 16/09/2026
132;MPV de teste;Compatibilidade;Validar fluxo crítico em celulares;Checklist mobile aprovado;Crítica;128-131;Qualidade;Em andamento;5;20/09/2026;20/09/2026;Matriz Chromium revalidada em 14/09/2026 com cinco viewports e 95 estados — roteiro físico incorporado em docs/VALIDACAO-MOBILE-MPV-2026-09-14.md com 12 verificações por plataforma identificação dos aparelhos evidências feedbacks técnicos e critério de aceite — pendente executar e registrar aprovação em Chrome Android e Safari iOS físicos e remover os dois feedbacks técnicos
...
134;MPV de teste;Qualidade;Executar QA do caminho feliz e falhas básicas;MPV candidato à validação;Crítica;132,133,138,139;Qualidade;Não iniciado;5;21/09/2026;21/09/2026;Validadores cobrem caminhos felizes pulo limpeza de escolha reinício cancelamento de saída sugestão opcional persistência exportação e serviço integrado de produção — iniciar aceite formal após concluir 132 e 133 e confirmar troca entre jogos sem estado residual
135;MPV de teste;Operação;Disponibilizar demonstração controlada;Link de demonstração;Crítica;134;Engenharia Frontend;Concluído;4;16/09/2026;16/09/2026;Demonstração HTTPS publicada no Render gratuito com Web Service PostgreSQL de 1 GB sonda de saúde CORS restrito bloqueio de indexação e segredo operacional — envio persistência e exportação validados base sintética removida e banco expira em 16/10/2026 sem backup — passagem física Android e iPhone continua na tarefa 132 antes de ampliar o teste
136;MPV de teste;Validação;Validar o formato com cinco casais;Placar dos critérios de decisão;Crítica;135;Product Owner — Tatyele Lopes;Não iniciado;8;23/09/2026;27/09/2026;Cada casal joga sem mediação e envia os três sinais do produto com sugestão de melhoria opcional — não há entrevistas nem etapa de pesquisa dentro do MPV
...
139;MPV de teste;Backend;Centralizar feedback e disponibilizar exportação controlada;API e CSV protegidos;Crítica;138;Engenharia Backend;Concluído;6;16/09/2026;16/09/2026;POST anônimo com validação idempotência controle de origem rate limit armazenamento PostgreSQL remoto com fallback JSON local e exportação CSV protegida por token — concluído em 16/09/2026
'@
