...
135;MPV de teste;Operação;Disponibilizar demonstração controlada;Link de demonstração;Crítica;134;Engenharia Frontend;Em andamento;4;16/09/2026;22/09/2026;Serviço único preparado e Blueprint do Render definido na região Virginia com plano pago disco persistente de 1 GB sonda de saúde CORS restrito bloqueio de indexação e segredo gerado — aguardando autenticação do workspace deploy HTTPS e validação do endereço final
...
139;MPV de teste;Backend;Centralizar feedback e disponibilizar exportação controlada;API e CSV protegidos;Crítica;138;Engenharia Backend;Concluído;6;16/09/2026;16/09/2026;POST anônimo com validação idempotência controle de origem rate limit e retenção no JSON além de exportação CSV protegida por token e testes automatizados — concluído em 16/09/2026
'@
...
$risks = @(
  ...
  @('MR06','Sugestão aberta conter nomes contatos ou detalhes pessoais','Privacidade','Média','Alto','Limitar a 500 caracteres orientar a não inserir dados pessoais restringir a exportação e aplicar retenção de 90 dias','Privacidade/Jurídico','Aberto')
)
