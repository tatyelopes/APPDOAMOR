...
135;MPV de teste;Operação;Disponibilizar demonstração controlada;Link de demonstração;Crítica;134;Engenharia Frontend;Em andamento;4;16/09/2026;22/09/2026;Blueprint gratuito do Render definido na região Virginia com Web Service PostgreSQL de 1 GB sonda de saúde CORS restrito bloqueio de indexação e segredo gerado — banco expira em 30 dias sem backup e aguardam deploy HTTPS exportação de teste e validação do endereço final
